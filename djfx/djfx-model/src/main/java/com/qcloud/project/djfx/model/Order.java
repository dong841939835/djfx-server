...
public class Order {
	...
	public Order(long id, String oName, long oNumber, double oSum, String oAddress, long roleId, long oPNumber,
			long productId, Date createTime, Date completionTime, int state, int processingState) {
		this.id = id;
		this.oName = oName;
