    ...
    <div class="col-xs-12">
        ...
        <form id="model-form" class="form-horizontal"  role="form" action="/admin/product/edit.do">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<input type="text" class="width-100" maxlength="20" id="productName" name="productName" placeholder="产品名称" value="${product.productName}"/>
						<i class="ace-icon fa"></i>
					</span>
                </div>
            </div>
            
			<input type="hidden" class="width-100" maxlength="20" id="thumbnail" name="thumbnail" placeholder="产品缩略图" value="${product.thumbnail}"/>
			
			<input type="hidden" class="width-100" maxlength="20" id="detailMap" name="detailMap" placeholder="产品详情图" value="${product.detailMap}"/>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<input type="text" class="width-100" maxlength="20" id="price" name="price" placeholder="产品价格" value="${product.price}"/>
						<i class="ace-icon fa"></i>
					</span>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<input type="text" class="width-100" maxlength="20" id="concessionalRate" name="concessionalRate" placeholder="优惠价" value="${product.concessionalRate}"/>
						<i class="ace-icon fa"></i>
					</span>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<input type="text" class="width-100" maxlength="20" id="specifications" name="specifications" placeholder="规格（150ml/瓶）" value="${product.specifications}"/>
						<i class="ace-icon fa"></i>
					</span>
                </div>
            </div>
            
            <input type="hidden" class="width-100" maxlength="20" id="sockId" name="sockId" placeholder="库存id" value="${product.sockId}"/>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<input type="hidden" id="productCategoryId" name="productCategoryId" value="${product.productCategoryId}"> 
						...
						readonly="readonly" api-path="/admin/productCategory/listProductCategory4Select.do" value="${product.productCategoryStr}"/>
						<i class="ace-icon fa"></i>
					</span>
                </div>
            </div>
