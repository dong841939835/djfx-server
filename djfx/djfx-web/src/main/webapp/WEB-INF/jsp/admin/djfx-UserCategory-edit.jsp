...
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <form id="model-form" class="form-horizontal"  role="form" action="/admin/userCategory/edit.do">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<input readonly="readonly" type="text" class="width-100" maxlength="20" id="type" name="type" placeholder="类型（1总部  2消费者 11一级经销商  12二级经销商）" value="${userCategory.type}"/>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<input type="text" class="width-100" maxlength="20" id="typeName" name="typeName" placeholder="类型名称" value="${userCategory.typeName}"/>
						<i class="ace-icon fa"></i>
					</span>
                </div>
            </div>
