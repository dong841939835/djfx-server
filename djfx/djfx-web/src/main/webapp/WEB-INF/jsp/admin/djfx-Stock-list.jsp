                    ...
                    <tbody>
                           <c:forEach items="${result}" var="item" varStatus="current"> 
                            <tr>            
                        					...
                        					src="<%=request.getContextPath()%>/qcloud-admin/assets/img/${item.productFile}"/></td>
                        					<!-- 放大后的图片 -->
                                ...
                                <div class="hidden-sm hidden-xs action-buttons">
                                    <a title="修改基本信息" class="green" 
                                       href="#admin/stock/toEdit?id=${item.id}&queryStr=${queryStr}">
                                        修改
                                    </a>	
                                    <a title="删除基本信息" class="red delete" data-id="${item.id}" style="cursor:pointer;"
												api-path="/admin/stock/delete.do">删除 
									</a>						                                 
                                </div>
                            </td>
                        </tr>
