...
public class AdminProductVO {
	...
	public AdminProductVO(long id, String productName, String thumbnail, String detailMap, String introduce,
			double price, double concessionalRate, String specifications, long sockId, Date createTime,
			long productCategoryId, long orderId, int state) {
		this.id = id;
	...
	public long getSockLong() {
		return sockLong;
	}

	public void setSockLong(long sockLong) {
		this.sockLong = sockLong;
	}
