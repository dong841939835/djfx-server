...
public class UserVO {
	...
	public UserVO(long id,String name,String userName,String password,String email,long phone,String contactAddress,long qq,String headPictureAddress,Date createTime,long idCard,String authorizationCode,long superiorId,long stockId,long roleCategoryId,int state){
		this.id = id;		
		this.name = name;		
